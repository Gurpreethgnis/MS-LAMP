...
use vars qw($upper $lower $mass $fa $gp $gl $pk $pr $round $st $cq $sfl $mac $mak $mono $di $diac $diak $diacak $diakac $tri $triac $spl $opl $flor $clor $brom $iod $sl $sp $workbook);
...
use vars qw($massentered $range @mzval $lenmz $counterentirelipidome $customquery $cq);
use vars qw($open $relativeintensityvalue @lstrcq $lstrcq $ogll @lstrogll $counterotherglycero $masschoice);
use vars qw($countersulfo $countermonoglycero $counterdiglycero  $countertriglycero  $countermainhalo $countermainglycero $countermainphospho $countercustomcheck $countersphingophospho  $counterotherphospho);

#**************************** Main Window Display********************************
$m = new MainWindow;
$m->geometry("1030x600+0+0");
$col="white";
$col1="dark grey";
$col2="light grey";
$col3="brown";
...
$counterentirelipidome=0;$counterfasearch=0;$countergpsearch=0;$counterglsearch=0;$counterstsearch=0;
	...
	$counterotherglycero=0;$qurdion="";$mass=0;
...
$counter2lihpos=0;$counterlipos=0;$counterli2hneg=0;$countermhpos=0;$countermampos=0;$counternapos=0;$counternahpos=0;$countermhneg=0;$counterachneg=0;$counternahneg=0;$countermmass=0;$counterclneg=0;
	$counterkpos=0;$counter2khpos=0;$counterk2hneg=0;$countermainglycero=0;

	$m->title("MS - LAMP - M. tb Lipidome MS-LAMP - Query Type 1 : Single Molecular Mass or m/z value");
		$sfmnbfore=$m->Frame(-background=>$col4,-relief=>ridge,-borderwidth=>4)->pack(-side=>top,-fill=>x);
	
	$sfmnbfore1=$sfmnbfore->Label( -text=>"",-font=>"{times new roman} 4",-background =>$col1,-foreground =>white)->pack(-side=>top,-fill=>x);	
	$sfmn=$sfmnbfore->Label( -text=>"Query Type 1 : Single Molecular Mass or m/z value",-font=>"{times new roman} 18 bold",-background =>$col1,-foreground =>$col5)->pack(-side=>top,-fill=>x);	
	$sfmnaftr=$sfmnbfore->Label( -text=>"",-font=>"{times new roman} 4",-background =>$col1,-foreground =>white)->pack(-side=>top,-fill=>x);	
	
	$massentry=$m->Frame(-background=>$col2,-foreground=>$col4)->pack(-side=>top,-anchor=>center,-fill=>x);
	$massentr=$massentry->Frame(-background=>$col2,-foreground=>$col4)->pack(-side=>top,-anchor=>center);
	$labelofscroll=$massentr->Label(-text=> "Enter Molecular Mass or m/z value (z = +/- 1) ",-font=>"{times new roman} 12 bold",-background=>$col2,-foreground=>$col4)->pack(-side=>left,-anchor=>center);	
	$massm =$massentr-> Entry(-relief=>sunken,-borderwidth=>5)->pack(-side=>left,-anchor=>center);
	$masschoice=0;
	$monoiso=$massentr->Radiobutton(-text=>"Monoisotopic ",-font=>"{times new roman} 10 bold",-value=>"0",-variable=>\$masschoice,-foreground=>$col4,-background=>$col2)->pack(-side=>left,-anchor=>center);
	$averagemass=$massentr->Radiobutton(-text=>"Average ",-font=>"{times new roman} 10 bold",-value=>"1",-variable=>\$masschoice,-foreground=>$col4,-background=>$col2)->pack(-side=>left,-anchor=>center);





		$iontype=$m->Label(-text=>"Choose Molecular Mass / Type of Ion",-font=>"{times new roman} 12 bold",-background=>$col1,-foreground=>$col4)->pack(-side=>top,-anchor=>center,-fill=>x);
	$frameiontype=$m->Frame(-background=>white,-foreground=>black)->pack(-side=>top,-anchor=>center);
	$windowrange=$m->Label     (-text=>"Window Range (+/-)",-font=>"{times new roman} 12 bold",-background=>$col1,-foreground=>$col4)->pack(-side=>top,-anchor=>center,-fill=>x);
	$framewrange=$m->Frame()->pack(-side=>top,-anchor=>center);
		$range="0.5";
		$mbyz=$framewrange->Label(-text=>"Molecular Mass or m/z  :   ",-font=>"{calibri} 12 bold",-activebackground=>"sky blue",-foreground=>black,-background=>white)->pack(-side=>left);
		$pointzz5=$framewrange->Radiobutton(-text=>"0.005 ",-font=>"{calibri} 12 bold",-activebackground=>"sky blue",-value=>"0.005",-variable=>\$range,-foreground=>black,-background=>white)->pack(-side=>left);
		$pointz1=$framewrange->Radiobutton(-text=>"0.01 ",-font=>"{calibri} 12 bold",-activebackground=>"sky blue",-value=>"0.01",-variable=>\$range,-foreground=>black,-background=>white)->pack(-side=>left);
		$pointz5=$framewrange->Radiobutton(-text=>"0.05 ",-font=>"{calibri} 12 bold",-activebackground=>"sky blue",-value=>"0.05",-variable=>\$range,-foreground=>black,-background=>white)->pack(-side=>left);		
	
		$point1=$framewrange->Radiobutton(-text=>"0.1 ",-font=>"{calibri} 12 bold",-activebackground=>"sky blue",-value=>"0.1",-variable=>\$range,-foreground=>black,-background=>white)->pack(-side=>left);
		$point25=$framewrange->Radiobutton(-text=>"0.25 ",-font=>"{calibri} 12 bold",-activebackground=>"sky blue",-value=>"0.25",-variable=>\$range,-foreground=>black,-background=>white)->pack(-side=>left);
		$point5=$framewrange->Radiobutton(-text=>"0.5 ",-font=>"{calibri} 12 bold",-activebackground=>"sky blue",-value=>"0.5",-variable=>\$range,-foreground=>black,-background=>white)->pack(-side=>left);
		$point75=$framewrange->Radiobutton(-text=>"0.75 ",-font=>"{calibri} 12 bold",-activebackground=>"sky blue",-value=>"0.75",-variable=>\$range,-foreground=>black,-background=>white)->pack(-side=>left);
		$pointone=$framewrange->Radiobutton(-text=>"1 ",-font=>"{calibri} 12 bold",-activebackground=>"sky blue",-value=>"1",-variable=>\$range,-foreground=>black,-background=>white)->pack(-side=>left);
$fontsizz=8.5;
...
$spaceaphospho=$m->Label(-text=>"___________________________________________________________________________________________________________________________________________________",-background=>white,-foreground=>$col4)->pack(-side=>top);
	...
	$customhelp=$framecustom->Button(-text=>"Need Help ?",-font=>"arial 10 ",-background=>$col2,-foreground=>$col3,-command=>\&s10)->pack(-side=>left);
	...
	$b=$m->Button(-text=>"SUBMIT",-font=>"{times new roman} 12 bold",-background =>$col4,-foreground =>$col,-relief => raised,-command=> \&searching)
...
{$comment="";
if ($masschoice eq 0){$comment="Monoisotopic";}
if ($masschoice eq 1){$comment="Average";}	
...
print " \n$changeinval";
$mass=$massm->get();
$masse=($mass+0.00000+$changeinval);
...
$massempty = 1;
$masscheckfornodata="";
$masscheckfornodata=$massm->get();
$masstoprint=$massm->get();
if ($masstoprint eq "") {$masstoprint="Value not entered";} 
...
if ($masscheckfornodata eq ""){$massempty = 1;}else{$massempty = 0;}


if (($massempty eq 1)&&
($counterentirelipidome eq 0) && ($countermainhalo eq 0) && ($countercustomcheck eq 0)&& ($countermainglycero eq 0)&& ($countersulfo eq 0) && ($countermonoglycero eq 0) && ($counterdiglycero eq 0) && ($countertriglycero eq 0) && ($counterotherglycero eq 0) && ($countermainphospho eq 0) && ($countersphingophospho eq 0) && ($counterotherphospho eq 0) && ($countermainphospho eq 0) && ($countersphingophospho eq 0)&& ($countergpsearch eq 0) && ($counterotherphospho eq 0)&& ($counterfasearch eq 0) && ($countergpsearch eq 0)&& ($counterglsearch eq 0) && ($counterpksearch eq 0) && ($counterprsearch eq 0) && ($counterspsearch eq 0) && ($counterslsearch eq 0) && ($counterstsearch eq 0) &&
($counter2lihpos eq 0)&&($counterlipos eq 0)&&($counterli2hneg eq 0)&& ($countermhpos eq 0) && ($countermampos eq 0)&&($counternapos eq 0) && ($counternahpos eq 0) && ($countermhneg eq 0)&&($counterachneg eq 0) && ($counternahneg eq 0)&&  ($countermmass eq 0) && ($counterclneg eq 0) &&($counterkpos eq 0)&& ($counter2khpos eq 0) &&($counterk2hneg eq 0)) 
{$errortoptitle="Result of the query";
$errortitle="Oops ! There are no results matching to the query  ";
$errormess="Enter Molecular mass or m/z value.\n Choose Molecular Mass or a Type of Ion . \nSelect one or more lipid category(ies).\n\n ";  
$errorbottom="Back";
...
if (($massempty eq 0)&&($round eq 0)&&( (($counterentirelipidome eq 1) |($countermainglycero eq 1)| ($countermainhalo eq 1)| ($countercustomcheck eq 1) | ($countersulfo eq 1) | ($countermonoglycero eq 1) | ($counterdiglycero eq 1)|($countertriglycero eq 1)|($counterotherglycero eq 1)|($countermainphospho eq 1) | ($countersphingophospho eq 1)|($counterotherphospho eq 1)| ($countermainphospho eq 1) | ($countersphingophospho eq 1) | ($countergpsearch eq 1) | ($counterotherphospho eq 1) | ($counterfasearch eq 1) | ($countergpsearch eq 1) | ($counterglsearch eq 1) | ($counterpksearch eq 1) | ($counterprsearch eq 1) | ($counterspsearch eq 1)| ($counterslsearch eq 1) | ($counterstsearch eq 1)) | (($counter2lihpos eq 1)|($counterlipos eq 1)|($counterli2hneg eq 1) | ($countermhpos eq 1) | ($countermampos eq 1)|($counternapos eq 1) | ($counternahpos eq 1) | ($countermhneg eq 1)|($counterachneg eq 1) | ($counternahneg eq 1)|  ($countermmass eq 1) | ($counterclneg eq 1) |($counterkpos eq 1)| ($counter2khpos eq 1) |($counterk2hneg eq 1)) ))	
{$errortoptitle="Result of the queryn";
$errortitle="Oops ! There are no results matching to the query ";
...
$m->title("MS - LAMP - M. tb Lipidome MS-LAMP : Result of the query for queried parameters -  m/z  : $mzvalueresult ($comment)\t , Ion type : $qurdion \t ,Window range :+/-  $range");
&entriessearching;
...
$ressps=$structureslabel->Label( -text=>"" ,-font=>"{Comic Sans Ms} 4 bold",-background =>$col1 ,-foreground => white)->pack(-side=>top,-fill=>x,-anchor=>center);
...
$ressps=$structureslabel->Label( -text=>"" ,-font=>"{Comic Sans Ms} 4 bold",-background =>$col1 ,-foreground => white)->pack(-side=>top,-fill=>x,-anchor=>center);
$resvaria=$structureslabel->Label( -text=>"Queried Parameters- \t m/z : $mzvalueresult ($comment)\t Ion type : $qurdion  \t Window range : +/- $range",-background =>white ,-foreground => black,-font=>"{Times new roman} 11 ")->pack(-side=>top,-fill=>x,-anchor=>center);		
...
sub csvoutput
{
$filetypescsv =[['Comma Saparated Values', '.csv'],
              ['All Files',   '*'],];
sub save_file {
$savecsv = $m->getSaveFile(-filetypes => $filetypescsv, 
                             -initialfile => 'MS-LAMP',
                             -defaultextension => '.csv');};
&save_file;
open OUT,">$savecsv" or die "cannot open the file";
...
{	print OUT "\n\n<<<< FATTY ACYLS >>>>\n\n";
	&csvouthead;
for	(sort keys %data)
	{if (($_>$lower) && ($_<$upper) && ( $data{$_} =~ /MMFA/))
		{&csvoutmain;}
	}
}
...
{	print OUT "\n\n<<<< GLYCEROLIPIDS >>>>\n\n";
	&csvouthead;
for(sort keys %data)
	{if (($_>$lower) && ($_<$upper) && ( $data{$_} =~ /MMGL/))
	{&csvoutmain;}
	}
};
...
{print OUT "\n\n<<<< GLYCEROPHOSPHOLIPIDS >>>>\n\n";
	&csvouthead;
for	(sort keys %data)
	{if (($_>$lower) && ($_<$upper) && ( $data{$_} =~ /MMGP/))
	{&csvoutmain;}
	}
}
...
&csvouthead;
for(sort keys %data)
	{if (($_>$lower) && ($_<$upper) && ( $data{$_} =~ /MMPK/))
	{&csvoutmain;}
	}
}
...
&csvouthead;
for(sort keys %data)
	{if (($_>$lower) && ($_<$upper) && ( $data{$_} =~ /MMPR/))
	{&csvoutmain;}
	}
}
...
&csvouthead;
for(sort keys %data)
	{if (($_>$lower) && ($_<$upper) && ( $data{$_} =~ /MMSL/))
	{&csvoutmain;}
	}
}
...
for(sort keys %data)
	{if (($_>$lower) && ($_<$upper) && ( $data{$_} =~ /MMSP/))
	{&csvoutmain;}
	}
}
...
&csvouthead;
for(sort keys %data)
	{if (($_>$lower) && ($_<$upper) && ( $data{$_} =~ /MMST/))
{&csvoutmain;		}
	}
}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && ( $m2sc{$_} =~ /$customquery/))
{&csvoutmain;}}
}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && ( ($m2f{$_} =~ /F/) |($m2f{$_} =~ /Cl/) |($m2f{$_} =~ /Br/) | ($m2f{$_} =~ /I/) ))
{&csvoutmain;}}}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && (($m2mc{$_} =~ /GL01/)|($m2mc{$_} =~ /GL02/) |($m2mc{$_} =~ /GL03/)|($m2mc{$_} =~ /GL00/)|($m2mc{$_} =~ /GL04/) |($m2mc{$_} =~ /GL05/)))
{&csvoutmain;}}}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && ($m2mc{$_} =~ /GL01/))
{&csvoutmain;}}}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && ($m2sc{$_} =~ /GL0101/))
{&csvoutmain;}}}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && ($m2sc{$_} =~ /GL0102/))
{&csvoutmain;}}}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && ($m2sc{$_} =~ /GL02/))
{&csvoutmain;}}}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && ($m2sc{$_} =~ /GL0203/))
{&csvoutmain;}}}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && ($m2sc{$_} =~ /GL0201/))
{&csvoutmain;}}}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && ($m2sc{$_} =~ /GL0207/))
{&csvoutmain;}}}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && ($m2sc{$_} =~ /GL0202/))
{&csvoutmain;}}}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && ($m2mc{$_} =~ /GL03/))
{&csvoutmain;}}}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && (($m2mc{$_} =~ /GL00/)|($m2mc{$_} =~ /GL04/)|($m2mc{$_} =~ /GL05/)))
{&csvoutmain;}}}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && (($m2f{$_} =~ /P/) && ($data{$_} =~ /MMGP/)) )
{&csvoutmain;}}}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && (($m2f{$_} =~ /P/) && ($data{$_} =~ /MMSP/)) )
{&csvoutmain;}}}
...
&csvouthead;
for(sort keys %data)
{if (($_>$lower) && ($_<$upper) && (($m2f{$_} =~ /P/ ) && (( $data{$_} =~ /MMFA/) | ( $data{$_} =~ /MMGL/) | ( $data{$_} =~ /MMSL/) | ( $data{$_} =~ /MMST/) | ( $data{$_} =~ /MMPR/) | ( $data{$_} =~ /MMPK/))) )
{&csvoutmain;}}}
...
sub csvoutmain{	$code = substr($_,0,-2);
		chomp $data{$_};
		$formforprint=substr($m2f{$_},1,-4);
		chomp $m2sn{$_};
		chomp $m2c{$_};
		chomp $m2mc{$_};
		print OUT "$code,\"$formforprint\",$m2sn{$_},$m2c{$_},$m2mc{$_},$m2sc{$_}";
		}
...
sub txtoutput
{
$filetypestxt =[['Text File', '.txt'],
              ['All Files',   '*'],];
sub save_file {
$savetxt = $m->getSaveFile(-filetypes => $filetypestxt, 
                             -initialfile => 'MS-LAMP',
                             -defaultextension => '.txt');
};

&save_file;
open OUT,">$savetxt" or die "cannot open the file";

if ($masschoice eq 0){$masschoiceforprinttxt ="M-Monoisotopic";}
if ($masschoice eq 1){$masschoiceforprinttxt ="M-Average";}

$mzvalueresult1=$massm->get();
	if ($countermhpos eq 1){$qurdion='[M+H]+'}		
	if($countermampos eq 1){$qurdion='[M+NH4]+'}		
	if($counternapos eq 1){$qurdion='[M+Na]+'}
	if($counternahpos eq 1){$qurdion='[M+2Na-H]+'}
...
if ($countermmass eq 1){print OUT "$masse\t\t$code";$delta=($code-($masse));}		
if ($countermhpos eq 1){$ionmhpos=$code+$ionmhposvalchange;print OUT "$masse\t\t\t$ionmhpos\t\t\t$code";$delta=($ionmhpos-($masse));}		
if($countermampos eq 1){$ionmampos=$code+$ionmamposvalchange;print OUT "$masse\t\t\t$ionmampos\t\t\t$code";$delta=($ionmampos-($masse));}		
if($counternapos eq 1){$ionnapos=$code+$ionnaposvalchange;print OUT "$masse\t\t\t$ionnapos\t\t\t$code";$delta=($ionnapos-($masse));}		
if($counternahpos eq 1){$ionnahneg=$code+$ion2nahposvalchange;print OUT "$masse\t\t\t$ionnahneg\t\t\t$code";$delta=($ionnahneg-($masse));}		
if($countermhneg eq 1){$ionmhneg=$code+$ionmhnegvalchange;print OUT "$masse\t\t\t$ionmhneg\t\t\t$code";$delta=($ionmhneg-($masse));}		
if($counterachneg eq 1){$ionachneg=$code+$ionachnegvalchange;print OUT "$masse\t\t\t$ionachneg\t\t\t$code";$delta=($ionachneg-($masse));}		
if($counternahneg eq 1){$ionnahneg=$code+$ionnahnegvalchange;print OUT "$masse\t\t\t$ionnahneg\t\t\t$code";$delta=($ionnahneg-($masse));}		
if($counterclneg eq 1){$ionclneg=$code+$ionclnegvalchange;print OUT "$masse\t\t\t$ionclneg\t\t\t$code";$delta=($ionclneg-($masse));}		
if($counterlipos eq 1){$ionlipos=$code+$ionliposvalchange;print OUT "$masse\t\t\t$ionlipos\t\t\t$code";$delta=($ionlipos-($masse));}		
if($counter2lihpos eq 1){$ion2lihpos=$code+$ion2lihposvalchange;print OUT "$masse\t\t\t$ion2lihpos\t\t\t$code";$delta=($ion2lihpos-($masse));}		
if($counterli2hneg eq 1){$ionli2hpos=$code+$ionlihnegvalchange;print OUT "$masse\t\t\t$ionli2hpos\t\t\t$code";$delta=($ionli2hpos-($masse));}		
if($counterkpos eq 1){$ionkpos=$code+$ionkposvalchange;print OUT "$masse\t\t\t$ionkpos\t\t\t$code";$delta=($ionkpos-($masse));}		
if($counter2khpos eq 1){$ion2khpos=$code+$ion2khposvalchange;print OUT "$masse\t\t$ion2khpos\t\t\t$code";$delta=($ion2khpos-($masse));}		
if($counterk2hneg eq 1){$ionk2hpos=$code+$ionk2hnegvalchange;print OUT "$masse\t\t$ionk2hpos\t\t\t$code";$delta=($ionk2hpos-($masse));}		
...
$filetypesxls =[['Excel Files', '.xls'],
              ['All Files',   '*'],];
sub save_file {
$savexls = $m->getSaveFile(-filetypes => $filetypesxls, 
                             -initialfile => 'MS-LAMP',
                             -defaultextension => '.xls');}

&save_file;
 $workbook = Spreadsheet::WriteExcel->new("$savexls");

if ($masschoice eq 0){$masschoiceforprintxls ="M-Monoisotopic";}
if ($masschoice eq 1){$masschoiceforprintxls ="M-Average";}
...
$formatheading->set_bold();
	...
	$summary->write($rowsummary,$columnsummary,'m/z value',$formatname);$columnsummary++;
	$summary->write($rowsummary,$columnsummary,$mzvalueresult1,$format);$columnsummary++;
...
if ($masschoice eq 1){$all->write($row, $col, 'M-Average (db)*', $format);$col++;}
	...
	$all->write($row, $col, 'FORMULAE', $format);$col++;
...
{$code = substr($_,0,-2);
$masse=$massm->get();
if ($countermmass eq 1){$all->write($row,$column,$masse);$column++;$all->write($row, $column,$code);$column++;$delta=($code-($mass));}		
if ($countermhpos eq 1){$all->write($row,$column,$masse);$column++;$ionmhpos=$code+$ionmhposvalchange;$all->write($row, $column, $ionmhpos);$column++;$all->write($row, $column,$code);$column++;$delta=($ionmhpos-($masse));}		
if($countermampos eq 1){$all->write($row,$column,$masse);$column++;$ionmampos=$code+$ionmamposvalchange;$all->write($row, $column, $ionmampos);$column++;$all->write($row, $column,$code);$column++;$delta=($ionmampos-($masse));}		
if($counternapos eq 1){$all->write($row,$column,$masse);$column++;$ionnapos=$code+$ionnaposvalchange;$all->write($row, $column, $ionnapos);	$column++;$all->write($row, $column,$code);$column++;$delta=($ionnapos-($masse));}		
if($counternahpos eq 1){$all->write($row,$column,$masse);$column++;$ionnahpos=$code+$ion2nahposvalchange;$all->write($row, $column, $ionnahpos);$column++;$all->write($row, $column,$code);$column++;$delta=($ionnahpos-($masse));}		
if($countermhneg eq 1){$all->write($row,$column,$masse);$column++;$ionmhneg=$code+$ionmhnegvalchange;$all->write($row, $column, $ionmhneg);$column++;$all->write($row, $column,$code);$column++;$delta=($ionmhneg-($masse));}		
if($counterachneg eq 1){$all->write($row,$column,$masse);$column++;$ionachneg=$code+$ionachnegvalchange;$all->write($row, $column, $ionachneg);$column++;$all->write($row, $column,$code);$column++;$delta=($ionachneg-($masse));}		
if($counternahneg eq 1){$all->write($row,$column,$masse);$column++;$ionnahneg=$code+$ionnahnegvalchange;$all->write($row, $column, $ionnahneg);$column++;$all->write($row, $column,$code);$column++;$delta=($ionnahneg-($masse));}		
if($counterclneg eq 1){$all->write($row,$column,$masse);$column++;$ionclneg=$code+$ionclnegvalchange;$all->write($row, $column, $ionclneg);$column++;$all->write($row, $column,$code);$column++;$delta=($ionclneg-($masse));}		
if($counterlipos eq 1){$all->write($row,$column,$masse);$column++;$ionlipos=$code+$ionliposvalchange;$all->write($row, $column, $ionlipos);$column++;$all->write($row, $column,$code);$column++;$delta=($ionlipos-($masse));}		
if($counter2lihpos eq 1){$all->write($row,$column,$masse);$column++;$ion2lihpos=$code+$ion2lihposvalchange;$all->write($row, $column, $ion2lihpos);$column++;$all->write($row, $column,$code);$column++;$delta=($ion2lihpos-($masse));}		
if($counterli2hneg eq 1){$all->write($row,$column,$masse);$column++;$ionlihneg=$code+$ionlihnegvalchange;$all->write($row, $column, $ionlihneg);$column++;$all->write($row, $column,$code);$column++;$delta=($ionlihneg-($masse));}		
if($counterkpos eq 1){$all->write($row,$column,$masse);$column++;$ionkpos=$code+$ionkposvalchange;$all->write($row, $column, $ionkpos);$column++;$all->write($row, $column,$code);$column++;$delta=($ionkpos-($masse));}		
if($counter2khpos eq 1){$all->write($row,$column,$masse);$column++;$ion2khpos=$code+$ion2khposvalchange;$all->write($row, $column, $ion2khpos);$column++;$all->write($row, $column,$code);$column++;$delta=($ion2khpos-($masse));}		
if($counterk2hneg eq 1){$all->write($row,$column,$masse);$column++;$ionk2hneg=$code+$ionk2hnegvalchange;$all->write($row, $column, $ionk2hneg);$column++;$all->write($row, $column,$code);$column++;$delta=($ionk2hneg-($masse));}		
		$all->write($row, $column,$delta);$column++;
$datafp=substr($data{$_},1,-2);
...
for	(sort keys %data)
	{$column=0;
	if (($_>$lower) && ($_<$upper) && (($m2mc{$_} =~ /GL01/)|($m2mc{$_} =~ /GL02/) |($m2mc{$_} =~ /GL03/)|($m2mc{$_} =~ /GL05/) |($m2mc{$_} =~ /GL04/)|($m2mc{$_} =~ /GL00/)))
{
&res;
$enterforcheck++;};
	};
